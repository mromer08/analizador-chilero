...
clase B hereda A {  -- B is a number squared
...
(*
   The clase A2I provides integer-to-string and string-to-integer
conversion routines.  To use these routines, either inherit them
in the clase where needed, have a dummy variable bound to
